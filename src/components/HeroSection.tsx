  ...
  <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 text-center px-4 max-w-3xl mx-auto">
      ...
      <p className="font-body text-base md:text-lg text-foreground/70 tracking-wide mb-10 opacity-0 animate-fade-in" style={{ animationDelay: "0.6s" }}>
        Professional haircuts & grooming by Ariel Sabag
      </p>
      <a
        href={BOOKING_URL}
        target="_blank"
        rel="noopener noreferrer"
        className="inline-block px-10 py-4 text-sm font-semibold uppercase tracking-[0.2em] bg-primary text-primary-foreground hover:brightness-110 hover:scale-105 transition-all duration-300 opacity-0 animate-fade-in"
